        ...
        <table class="header-table">
            <tr>
                ...
                <td class="content-cell">
                    ...
                    <div class="report-title">Borrowing History Report</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $record->faculty->faculty_name ?? 'N/A' }}</td>
            ...
            @empty
            <tr>
                <td colspan="5" style="text-align: center; padding: 20px;">No borrowing history found for this user.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
