...
<body class="bg-gray-50 min-h-screen p-4 md:p-8">
    ...
    <div class="max-w-5xl mx-auto"> 
        ...
        <div class="bg-white rounded-lg shadow-md p-8"> 
            <form action="{{ route('items.update', ['item' => $item->id]) }}" method="POST" class="space-y-8"> 
                @csrf
                @method('PUT')
                <div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="mt-1 block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-base">{{$item->description}}</textarea>
                </div>
                ...
                <div>
                    ...
                    <select name="is_available" id="is_available" 
                            class="mt-1 block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-base">
                        <option value="1" {{ $item->is_available == 1 ? 'selected' : '' }}>Yes</option>
